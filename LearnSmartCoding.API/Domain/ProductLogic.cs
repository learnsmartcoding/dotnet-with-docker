...
namespace LearnSmartCoding.Api.Domain
{
    public class ProductLogic : IProductLogic
    {
        ...
        private static IEnumerable<Product> GetAllProducts()
        {
            ...
            {
                new Product { Id = 1, Name = "Trailblazer", Category = "boots", Price = 99.99,
                    Description = "Great support in this high-top to take you to great heights and trails." },
                new Product { Id = 2, Name = "Coastliner", Category = "boots", Price = 59.99,
